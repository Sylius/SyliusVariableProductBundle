...
use Sylius\Bundle\VariableProductBundle\Model\Option\OptionInterface;
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        if (!isset($options['options']) ||
            ...
            throw new FormException(
                'array or (\Traversable and \ArrayAccess) of "Sylius\Bundle\VariableProductBundle\Model\Option\OptionInterface" must be passed to collection'
            );
        }
        foreach ($options['options'] as $i => $option) {
            if (!$option instanceof OptionInterface) {
                throw new FormException('Each object passed as option list must implement "Sylius\Bundle\VariableProductBundle\Model\Option\OptionInterface"');
            }
